...
cl.login(token="EmvnM8TldohVoyqi0HG0.xDUGSdzVmTfiL574EE3X8a.n16Y9ZXs56n+iyRHz4DMx2auuVKduuYFtL7MldjNKe0=")
cl.loginResult()

ki = LINETCR.LINE() #Layla
ki.login(token="EmpNEsUYE7qedrotyZp7.rcIIDG+inxame+bk+OW9DW.5M6isrnlYyThBrb4OeXQwWvWtP9boKNFZmOZ84UWeyQ=")
ki.loginResult()

kk = LINETCR.LINE() #Lancelot
kk.login(token="Emiez7JSduga3qibSNJ7.0NQa6n0mJX3TMK0munJIjW.XrBI5QIqGdXvRgx4qkcYBwrZtXGJZbiSbuD1VIAW5rA=")
kk.loginResult()

kc = LINETCR.LINE() #odette
kc.login(token="Em7qKzmoy6uGMSyFtFA3.VvX6sxmyBuQ2dnQXufBESW.Oo4hon37iOQ0IW0zRUTSlccfpZ2hAB4maJApyeTntzI=")
kc.loginResult()

ks = LINETCR.LINE() #Roger
ks.login(token="EmsoxeDXVX7SLs8tT6ud.zYGYtJSnL3qhvvoNU1zQBq.VHmJ3yFM/WvMCNhiSzER8ue6uAPcJpd2jb4BhbUTy5k=")
ks.loginResult()

ka = LINETCR.LINE() #Karina
ka.login(token="Em4XLIgAxUdnyywWixU1.s6X4dogBSorpxQPJgHxwOq.FhTx3QQ8u6O0cDbDG4O0L7L/gFp74sXLDXnaq4/XFp4=")
ka.loginResult()

kb = LINETCR.LINE() #Freya
kb.login(token="EmxGdBjRUmprpAcw6p86.aNyDoEqVyfEBLzGAFkbRjG.SlB3xiP691l1kjW/wzUhreOzNpH/Eu3ppOT8koA3GRA=")
kb.loginResult()

ko = LINETCR.LINE() #Chiclops
ko.login(token="EmRW4QHMzFT89vCebxce.NdrswmyV7l2MMzDlrxduNG.ynScPxofcWScbLVzfjpVCJil9qAKmN8Yb3B7dlbxoIE=")
ko.loginResult()

ke = LINETCR.LINE() #Alucard
ke.login(token="EmOXBdzg82NTFrVKAfjc.SdiXsNZDfuuraCinPWAMta.pyYROvaUNMbOgLyZfoF3fmcjHTLKMxeCs/NxC5633Eo=")
ke.loginResult()

ku = LINETCR.LINE() #Franco
ku.login(token="Em1FljMJzg7YZ5Rvk826.Sl/qjS3LvuwC0UW09yAFLG.yrc9EKYrHE6LuZKs9B6e8mBZCOQoLEyPhbg6LcQot3o=")
ku.loginResult()
...
admin=["u457cf410aa13c3d8b6cf2f9ddf5cdb20","u5ddba0b0366f32d148979ef879edf1f0"]
owner=["u5ddba0b0366f32d148979ef879edf1f0"]
wait = {
    'contact':False,
    'autoJoin':True,
